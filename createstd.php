<div class="row" style="width:98%; margin:auto">
	<div class="col-md-4">
		<form method="post" action="" id="login_form1">
			...
			<div class="form-group">
				<label class="control-label">Employee Reg. No</label>
			...
			<div class="form-group">
				<div class="well well-sm">
					<h5>Please wait while the system generate project topic for this Employee....</h5>
...
$("#login_form1").submit(function(e){
		...
		$.ajax({
			...
			if(html=='true')
			{
				...
				$.jGrowl("Employee successfully added & assigned", { header: 'Success !!' });
				var delay = 5000;
