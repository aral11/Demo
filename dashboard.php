...
<body style="width:100vw; margin:0px;  background-color: lightblue;" >
<?php include 'dashboard_navbar.php'; ?>
<h3 style="text-align:center; font-weight:bold">Project Allocation Details</h3>
<div class="table-responsive" style="width: 98%;margin: auto;">
	<table class="table table-bordered table-striped table-hover project_table" style="width:100vw; margin:0px;  background-color: white;">
		<thead>
			<tr>
				<th>ID</th>
				<th>Employee Name</th>
